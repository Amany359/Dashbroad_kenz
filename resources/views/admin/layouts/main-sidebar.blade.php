        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href=" {{ route('admin.employee') }} "  class="menu-link">
              <div class="text-truncate" data-i18n="Without menu">Transactions</div>
            </a>
          </li>
          <li class="menu-item">
            <a href=" {{ route('admin.dashboard') }} " class="menu-link">
              <div class="text-truncate" data-i18n="Without navbar">Products</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{ route('admin.engineer') }}" class="menu-link">
              <div class="text-truncate" data-i18n="Fluid">engineer</div>
            </a>
          </li>
          <li class="menu-item">
